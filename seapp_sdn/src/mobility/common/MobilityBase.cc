...
void MobilityBase::transferToTargetPosition(Coord targetPosition) {

	// force the node to new position
	lastPosition = targetPosition;
	
	// translate the constraint area
	constraintAreaMin += targetPosition;
	constraintAreaMax += targetPosition;
	
	// emit mobility state change signal
    emitMobilityStateChangedSignal();
